...
function CuisinePage() {
  ...
  const handleExportCsv = () => {
    ...
    const header = ["grand_parent", "parent", "cuisine", "is_curation_enabled"];
    ...
    a.href = url;
    a.download = `cuisines-${new Date().toISOString().slice(0, 10)}.csv`;
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-6">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold text-slate-900">Cuisines</h1>
      ...
      {loading ? (
        ...
        <p className="text-sm text-slate-500">No cuisines found.</p>
      ) : (
