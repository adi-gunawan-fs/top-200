...
import { fetchCourseTypes } from "../lib/api";
...
function CourseTypePage() {
  ...
  const handleExportCsv = () => {
    ...
    const header = ["grand_parent", "parent", "course_type", "is_curation_enabled", "is_ignored"];
    ...
    a.href = url;
    a.download = `course-types-${new Date().toISOString().slice(0, 10)}.csv`;
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-6">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold text-slate-900">Course Type</h1>
      ...
      {loading ? (
        ...
        <p className="text-sm text-slate-500">No course types found.</p>
      ) : (
